...
export function TabsList({ className, ...props }) {
  return (
    <div
      className={cn('inline-flex h-11 items-center rounded-xl bg-surface-container p-1 text-on-surface-variant', className)}
      {...props}
    />
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? 'bg-surface text-on-surface shadow-sm' : 'hover:text-on-surface',
        className
      )}
      {...props}
    >
