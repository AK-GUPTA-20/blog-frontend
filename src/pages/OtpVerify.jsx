      ...
      >
        ...
        <div className="bg-surface-container-low border border-outline-variant/40 rounded-[2rem] p-8 shadow-2xl backdrop-blur-xl">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-on-surface-variant mb-3">Didn't receive it?</p>
            <button
            ...
            >
              <AnimatePresence mode="wait">
                {resending
                  ? <motion.span key="loading" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}><Loader2 size={15} className="animate-spin" /></motion.span>
                  : <motion.span key="icon" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}><RefreshCw size={15} /></motion.span>
                }
              </AnimatePresence>
          ...
          <p className="text-center mt-6 text-sm text-on-surface-variant">
            Wrong email?{' '}
            <Link to="/register" className="text-primary font-bold hover:underline">Go back</Link>
          </p>
        </div>
      </motion.div>
    </div>
