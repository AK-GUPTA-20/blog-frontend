    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-on-surface-variant">Share your thoughts and ideas with the world.</p>
        </div>
        ...
        <div className="space-y-6">
          <div className="glass-card rounded-2xl p-6 sm:p-8 space-y-6">
              ...
              <div className="relative border-2 border-dashed border-outline-variant/40 rounded-xl p-6 hover:border-primary/40 transition-colors cursor-pointer group">
                ...
                {imagePreview ? (
                  ...
                  <div className="flex flex-col items-center justify-center text-center">
                    <ImageIcon size={40} className="text-on-surface-variant/50 mb-3 group-hover:text-primary transition-colors" />
                    <p className="text-on-surface font-semibold">Click or drag to upload image</p>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-3">
                ...
                />
                <Button onClick={handleAddTag} variant="outline" className="px-6">
                  Add
                </Button>
              </div>
          ...
          <div className="flex gap-4 justify-end">
            <Button
              ...
              className="px-6"
            >
              {loading ? <Loader2 size={18} className="animate-spin" /> : 'Save as Draft'}
            </Button>
            <Button
              ...
              className="px-6"
            >
              {loading ? <Loader2 size={18} className="animate-spin" /> : (form.status === 'scheduled' ? 'Schedule' : 'Publish')}
            </Button>
          </div>
        </div>
      </div>
